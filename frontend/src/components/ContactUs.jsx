...
export default function ContactUs() {
  ...
  useEffect(() => {
    ...
    // Grades are embedded as refs on the product — fetch all grades and filter
    gradesApi
      .list()
      .then((res) => {
        const data = res.data;
  ...
  const handleChange = (e) => {
    ...
    setForm((prev) => {
      // Reset grade & color when product changes
      if (name === 'product') {
    ...
    return (
      <section className="mt-16 pt-16 border-t border-slate-200">
        <div className="max-w-2xl mx-auto text-center py-12">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Thank you for reaching out!</h2>
  ...
  const inputClass =
    'w-full px-4 py-2.5 rounded-lg border border-slate-300 bg-white text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500 transition-colors placeholder:text-slate-400';
  const labelClass = 'block text-sm font-medium text-slate-700 mb-1.5';

  return (
    <section id="contact" className="mt-16 pt-16 border-t border-slate-200 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:contact@colorsmith.com" className="text-sm text-slate-600 hover:text-amber-600 transition-colors">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+919311029421" className="text-sm text-slate-600 hover:text-amber-600 transition-colors">
                    +91 93110 29421
                  </a>
                </div>
              </div>
          ...
          <div className="lg:col-span-3">
            <form
              ...
              className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 sm:p-8 space-y-5"
            >
              {/* Row: Company + Email */}
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full px-6 py-3 rounded-xl bg-amber-500 text-white font-semibold hover:bg-amber-600 transition-all shadow-sm hover:shadow disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <p className="text-xs text-slate-400 text-center">
                ...
                <a href="/policies/privacy" className="underline hover:text-slate-600">privacy policy</a>.
              </p>
            </form>
          </div>
        </div>
