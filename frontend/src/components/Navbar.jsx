...
export default function Navbar() {
  ...
  const navLinkClass = ({ isActive }) =>
    `px-3 py-2 rounded-lg text-sm lg:text-base font-medium transition-colors ${
      isActive
  ...
  return (
    <>
      {/* ⭐ UPDATED HEADER */}
      <header
        className={`font-display bg-black fixed top-0 left-0 w-full z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md shadow-sm transform transition-transform duration-300 ${
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden sm:flex items-center gap-1">
              <button
                ...
                className="px-3 py-2 rounded-lg text-sm lg:text-base font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100"
              >
                Home
              </button>
